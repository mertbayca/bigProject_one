...
const footer = () => {
  return (
    <div className="scop__footer section__padding">
      <div className="scop__footer-heading">
        <h1 className="gradient__text">Step into the future and become the leaders of tomorrow.</h1>
      </div>
      <div className="scop__footer-links">
        <div className="scop__footer-links_logo">
          <img src={flogo} alt="logo"/>
          <p>Website created by Mert Bayça. All rights reserved</p>
        </div>
        <div className="scop__footer-links_div">
          <h4>Links</h4>
          <p>Social Media</p>
          <p>Contact</p>
        </div>
      ...
      <div className="scop__footer-copyright">
